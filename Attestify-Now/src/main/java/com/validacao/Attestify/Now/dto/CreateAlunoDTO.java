...
public class CreateAlunoDTO {
    ...
    @NotBlank(message = "Grau de parentesesco é um campo obrigatório!")
    private String grauParentesco;

    @NotNull(message = "Data de nascimento do responsável é um campo obrigatório!")
    @JsonFormat(pattern = "dd-MM-yyyy")
    ...
    @NotBlank(message = "Modalidade é um campo obrigatório!")
    private String modalidade;

    @NotBlank(message = "Turma é um campo obrigatório!")
    private String turma;

    @NotBlank(message = "Turno é um campo obrigatório!")
